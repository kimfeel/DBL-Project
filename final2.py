...
def temp_hum_light_loop():
    global temperature, humidity, lux, sensor, pin
...
def sound_loop():
    ...
    if len(data) == win_s:
        ...
        #print freq
        if freq > 130 and freq < 200 and energy > 20000:
            count = count + 1
            if max_freq < freq:
                max_freq = freq
                max_energy = energy    
            print("{0:d} {1:10.4f} {2:10.4f}".format(count,freq,energy))# read data from audio input
